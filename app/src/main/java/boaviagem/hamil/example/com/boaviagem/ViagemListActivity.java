...
public class ViagemListActivity extends ListActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //quando for extends ListActivity implements AdapterView.OnItemClickListener no pode usar alinha de baixo
        ...
        SimpleAdapter adapter =  new SimpleAdapter(this, listarViagens(),
                       R.layout.activity_lista_viagem, de, para);
    ...
    private void binding() {
        viagem = findViewById( R.id.listaViagemId );
    }
