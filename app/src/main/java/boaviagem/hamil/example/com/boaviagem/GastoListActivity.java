...
public class GastoListActivity extends ListActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SimpleAdapter adapter = new SimpleAdapter(this,
                listarGastos(), R.layout.activity_lista_gasto, de, para);

        //chama a troca de cor de linha
...
// pode adicionar mais informações de viagens
    ...
    private void binding() {
        gasto = findViewById( R.id.listagastoId );
    }
    ...
    //metodo para mudar a cor da item lista de acordo com o produto
